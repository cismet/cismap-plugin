 ...
 */
public class AddToSelectionAttributeTableSearchMethod implements QuerySearchMethod {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(AddToSelectionAttributeTableSearchMethod.class);
     ...
     */
    public AddToSelectionAttributeTableSearchMethod(final AttributeTable table) {
        this.table = table;
    }
    ...
    public String toString() {
        return NbBundle.getMessage(
                AddToSelectionAttributeTableSearchMethod.class,
                "AddToSelectionAttributeTableSearchMethod.toString");
    }
