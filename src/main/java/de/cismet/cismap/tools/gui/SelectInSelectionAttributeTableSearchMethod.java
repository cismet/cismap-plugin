 ...
 */
public class SelectInSelectionAttributeTableSearchMethod implements QuerySearchMethod {
     ...
     */
    public SelectInSelectionAttributeTableSearchMethod(final AttributeTable table) {
        this.table = table;
    }
    ...
    public String toString() {
        return NbBundle.getMessage(
                SelectInSelectionAttributeTableSearchMethod.class,
                "SelectInSelectionAttributeTableSearchMethod.toString");
    }
