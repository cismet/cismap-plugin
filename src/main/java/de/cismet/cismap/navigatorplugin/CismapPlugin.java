 ...
 */
public class CismapPlugin extends javax.swing.JFrame implements PluginSupport, Observer, FloatingPluginUI, Configurable,
        MapSearchListener, MapDnDListener, StatusListener, HistoryModelListener, FeatureCollectionListener {

    /** Use serialVersionUID for interoperability. */
    private final static long serialVersionUID = -1807202388272879897L;
    ...
    DataFlavor fromNavigatorNode = new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType + ";class="
            + DefaultMetaTreeNode.class.getName(), "a DefaultMetaTreeNode"); // NOI18N
...
// mapC.getFeatureCollection()).fireFeaturesChanged(v); } }
                                ...
                                JOptionPane.showMessageDialog(null,
                                        "The given value was not a floating point value.!", "Error",
    ...
    public CismapPlugin(final PluginContext context) {
        ...
        try {
            ...
            if (plugin && (context.getEnvironment() != null) && this.context.getEnvironment().isProgressObservable()) {
                this.context.getEnvironment().getProgressObserver().setProgress(0,
                        org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            if (plugin && (context.getEnvironment() != null) && this.context.getEnvironment().isProgressObservable()) {
                this.context.getEnvironment().getProgressObserver().setProgress(100,
                        org.openide.util.NbBundle.getMessage(CismapPlugin.class,
...
// getRootPane().getActionMap().put("UPSIDEDOWN", upsidedownAction);
            ...
            if (plugin && (context.getEnvironment() != null) && this.context.getEnvironment().isProgressObservable()) {
                this.context.getEnvironment().getProgressObserver().setProgress(200,
                        org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            if (!plugin) {
                ...
                KeyStroke configLoggerKeyStroke = KeyStroke.getKeyStroke('L',
                ...
                getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(configLoggerKeyStroke,
            ...
            if (plugin && (context.getEnvironment() != null) && this.context.getEnvironment().isProgressObservable()) {
                this.context.getEnvironment().getProgressObserver().setProgress(300,
                        org.openide.util.NbBundle.getMessage(CismapPlugin.class,
...
// broker.setLayerWidget(activeLayers);
            ...
            try {
                ...
                if (cismapconfig == null) {
                    cismapconfig = context.getEnvironment().getParameter(prefix + username + "@" + groupname + "@"
                            + domainname); // NOI18N
                }

                // Second try: cismapconfig:*@usergroup@domainserver
                if (cismapconfig == null) {
                    cismapconfig = context.getEnvironment().getParameter(prefix + "*" + "@" + groupname + "@"
                            + domainname); // NOI18N
                }
            ...
            if (plugin && (context.getEnvironment() != null) && this.context.getEnvironment().isProgressObservable()) {
                this.context.getEnvironment().getProgressObserver().setProgress(400,
                        org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            Icon icoLayers = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/cismap/commons/raster/wms/res/layers.png")); // NOI18N
            Icon icoServer = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/cismap/commons/raster/wms/res/server.png")); // NOI18N
            Icon icoServerInfo = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/cismap/commons/gui/capabilitywidget/res/serverInfo.png")); // NOI18N
            Icon icoLayerInfo = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/cismap/commons/gui/capabilitywidget/res/layerInfo.png")); // NOI18N
            Icon icoFeatureInfo = new javax.swing.ImageIcon(getClass().getResource(
                    "/de/cismet/cismap/commons/gui/featureinfowidget/res/featureInfo16.png")); // NOI18N
            Icon icoLegend = new javax.swing.ImageIcon(getClass().getResource(
            ...
            vMap = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vLayers = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vCaps = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vServerInfo = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vOverview = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vLayerInfo = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vLegend = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            if (plugin) {
                vMetaSearch = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vFeatureInfo = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            vFeatureControl = new View(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            JMenu wfsFormsMenu = new JMenu(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
            ...
            for (String key : keySet) {
                ...
                final View formView = new View(form.getTitle(), Static2DTools.borderIcon(form.getIcon(), 0, 3, 0, 1),
                        form);
            ...
            //Cismap Extensions
            Collection<? extends BasicGuiComponentProvider> guiCompProviders = Lookup.getDefault().lookupAll(
            ...
            AlphaGradientComponentPainter x = new AlphaGradientComponentPainter(
                    java.awt.SystemColor.inactiveCaptionText, java.awt.SystemColor.activeCaptionText,
                    java.awt.SystemColor.activeCaptionText, java.awt.SystemColor.inactiveCaptionText);
            ...
            if (plugin && (context.getEnvironment() != null) && this.context.getEnvironment().isProgressObservable()) {
                this.context.getEnvironment().getProgressObserver().setProgress(500,
                        org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        if (plugin) {
            ...
            try {
                ...
                if ((context != null) && (context.getEnvironment() != null)
                        && this.context.getEnvironment().isProgressObservable()) {
                    this.context.getEnvironment().getProgressObserver().setProgress(600,
                            org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                ...
                if ((context != null) && (context.getEnvironment() != null)
                        && this.context.getEnvironment().isProgressObservable()) {
                    this.context.getEnvironment().getProgressObserver().setProgress(700,
                            org.openide.util.NbBundle.getMessage(CismapPlugin.class,
...
// configureApp(false);
                if ((context != null) && (context.getEnvironment() != null)
                        && this.context.getEnvironment().isProgressObservable()) {
                    this.context.getEnvironment().getProgressObserver().setProgress(1000,
                            org.openide.util.NbBundle.getMessage(CismapPlugin.class,
...
// initPluginToolbarComponents();
    ...
    private void initPluginToolbarComponents() {
        Collection<? extends ToolbarComponentsProvider> toolbarCompProviders = Lookup.getDefault().lookupAll(
        ...
        if (toolbarCompProviders != null) {
            ...
            for (ToolbarComponentsProvider toolbarCompProvider : toolbarCompProviders) {
                ...
                Collection<ToolbarComponentDescription> componentDescriptions =
    ...
    private void initComponents() {
        ...
        cmdBack = new JHistoryButton() {
                @Override public void historyActionPerformed() {
        ...
        mnuConfigServer.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        menBookmarks.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniAddBookmark.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniBookmarkManager.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniBookmarkSidebar.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchRectangle1.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchPolygon1.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchEllipse1.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchPolyline1.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchShowLastFeature1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y,
                java.awt.event.InputEvent.CTRL_MASK));
        mniSearchShowLastFeature1.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.mniSearchShowLastFeature1.text")); // NOI18N
        mniSearchShowLastFeature1.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchRedo1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y,
                java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        mniSearchRedo1.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.mniSearchRedo1.text")); // NOI18N
        mniSearchRedo1.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchBuffer1.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.mniSearchBuffer1.text")); // NOI18N
        mniSearchBuffer1.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        addComponentListener(new java.awt.event.ComponentAdapter() {
                ...
                @Override public void componentShown(java.awt.event.ComponentEvent evt) {
        ...
        cmdReconfig.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdBack.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdHome.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdForward.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdRefresh.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdPrint.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdClipboard.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.cmdClipboard.text")); // NOI18N
        cmdClipboard.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        togInvisible.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdSelect.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdZoom.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdPan.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdFeatureInfo.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdPluginSearch.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdNewPolygon.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdNewLinestring.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdNewPoint.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdMoveGeometry.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdRemoveGeometry.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdNodeMove.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdNodeAdd.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdNodeRemove.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdNodeRotateGeometry.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdSnap.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdUndo.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        cmdRedo.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniLoadConfig.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_L,
                java.awt.event.InputEvent.CTRL_MASK));
        mniLoadConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/config.png"))); // NOI18N
        mniLoadConfig.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSaveConfig.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_K,
                java.awt.event.InputEvent.CTRL_MASK));
        mniSaveConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/config.png"))); // NOI18N
        mniSaveConfig.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniLoadConfigFromServer.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSaveLayout.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,
                java.awt.event.InputEvent.CTRL_MASK));
        mniSaveLayout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/layout.png"))); // NOI18N
        mniSaveLayout.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniLoadLayout.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O,
                java.awt.event.InputEvent.CTRL_MASK));
        mniLoadLayout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/layout.png"))); // NOI18N
        mniLoadLayout.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniClipboard.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C,
                java.awt.event.InputEvent.CTRL_MASK));
        mniClipboard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/clipboard16.png"))); // NOI18N
        mniClipboard.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniGeoLinkClipboard.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C,
                java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        mniGeoLinkClipboard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/clipboard16.png"))); // NOI18N
        mniGeoLinkClipboard.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniPrint.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniClose.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F4,
        ...
        mniZoomToSelectedObjects.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniZoomToAllObjects.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniRemoveSelectedObject.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniRemoveAllObjects.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniBack.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_LEFT,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniForward.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_RIGHT,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniHistorySidebar.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchRectangle.setSelected(true);
        mniSearchRectangle.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchPolygon.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchEllipse.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchPolyline.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchShowLastFeature.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y,
                java.awt.event.InputEvent.CTRL_MASK));
        mniSearchShowLastFeature.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.mniSearchShowLastFeature.text")); // NOI18N
        mniSearchShowLastFeature.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchRedo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Y,
                java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        mniSearchRedo.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.mniSearchRedo.text")); // NOI18N
        mniSearchRedo.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniSearchBuffer.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.mniSearchBuffer.text_1")); // NOI18N
        mniSearchBuffer.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniGotoPoint.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_G,
                java.awt.event.InputEvent.CTRL_MASK));
        mniGotoPoint.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/goto.png"))); // NOI18N
        mniGotoPoint.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniScale.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniLayer.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_1,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniCapabilities.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_2,
                java.awt.event.InputEvent.CTRL_MASK));
        mniCapabilities.setIcon(new javax.swing.ImageIcon(
                getClass().getResource("/de/cismet/cismap/commons/raster/wms/res/server.png"))); // NOI18N
        mniCapabilities.setMnemonic('C');
        mniCapabilities.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniFeatureInfo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_3,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniFeatureInfo.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniClassTree.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_4,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniClassTree.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniServerInfo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_5,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniServerInfo.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniLayerInfo.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_6,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniLayerInfo.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniLegend.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_7,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniFeatureControl.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_8,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniFeatureControl.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniMap.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_9,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniOverview.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_0,
                java.awt.event.InputEvent.CTRL_MASK));
        ...
        mniResetWindowLayout.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R,
                java.awt.event.InputEvent.CTRL_MASK));
        mniResetWindowLayout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/layout.png"))); // NOI18N
        mniResetWindowLayout.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                "CismapPlugin.mniResetWindowLayout.text")); // NOI18N
        mniResetWindowLayout.setToolTipText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniOnlineHelp.setText(org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        mniAbout.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A,
                java.awt.event.InputEvent.ALT_MASK | java.awt.event.InputEvent.CTRL_MASK));
...
// });
                ...
                String u = "http://localhost:" + httpInterfacePort + "/gotoBoundingBox?x1=" + bb.getX1()
    ...
    private void mniGotoPointActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniGotoPointActionPerformed
        ...
        try {
            ...
            String s = JOptionPane.showInputDialog(this,
                    ...
                    StaticDecimalTools.round(x) + "," + StaticDecimalTools.round(y)); // NOI18N
    ...
    private void mniScaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniScaleActionPerformed
        ...
        try {
            String s = JOptionPane.showInputDialog(this,
                    ...
                    ((int) mapC.getScaleDenominator()) + ""); // NOI18N
    ...
    private void mniLoadConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniLoadConfigActionPerformed
        ...
        fc.setFileFilter(new FileFilter() {
            ...
            public String getDescription() {
                return org.openide.util.NbBundle.getMessage(CismapPlugin.class,
        ...
        if (layoutFile.exists()) {
            ...
            if (isInit) {
                ...
                JOptionPane.showMessageDialog(this,
                        ...
                        org.openide.util.NbBundle.getMessage(CismapPlugin.class,
                        "CismapPlugin.loadLayout(String).JOptionPane.title"), JOptionPane.INFORMATION_MESSAGE); // NOI18N
            }
        }
    }
...
// log.error("ogcPolygon:"+ogcPolygon); log.fatal("newStuff:"+ geom.toText());
        ...
        context.getSearch().performSearch(metaSearch.getSearchTree().getSelectedClassNodeKeys(), coordinatesDataBean,
                context.getUserInterface().getFrameFor((PluginUI) this), false);
    }
...
// if (f instanceof CidsFeature) {
                                ...
                                try {
                                    ...
                                    if (request.getLocalAddr().equals(request.getRemoteAddr())) {
                                        ...
                                        if (target.equalsIgnoreCase("/gotoBoundingBox")) { // NOI18N
                                            ...
                                            try {
                                                BoundingBox bb = new BoundingBox(new Double(x1),
                                                        new Double(y1), new Double(x2), new Double(y2));
                                        ...
                                        if (target.equalsIgnoreCase("/gotoScale")) { // NOI18N
                                            ...
                                            String x1 = request.getParameter("x1"); // NOI18N
                                            String y1 = request.getParameter("y1"); // NOI18N
                                            String scaleDenominator = request.getParameter(
                                                    "scaleDenominator"); // NOI18N

                                            try {
                                                BoundingBox bb = new BoundingBox(new Double(x1),
                                                        new Double(y1), new Double(x1), new Double(y1));

                                                mapC.gotoBoundingBoxWithHistory(
                                                        mapC.getScaledBoundingBox(new Double(scaleDenominator).doubleValue(), bb));
                                            } catch (Exception e) {
                                                log.warn("gotoBoundingBox failed", e); // NOI18N
                                            }
                                        }
    ...
    private class NodeChangeListener extends MetaNodeSelectionListener {
        ...
        private NodeChangeListener() {
            ...
            AttributeRestriction attributeRestriction = new ComplexAttributeRestriction(AttributeRestriction.OBJECT,
                    AttributeRestriction.IGNORE, null, this.attributeNames, null);
            this.attributeIterator = new SingleAttributeIterator(attributeRestriction, false);
        }

        @Override
        protected void nodeSelectionChanged(
                Collection wirdNichtGebrauchtWeilScheissevonPascalgefuelltCollection) {
...
// if (mapC.getFeatureCollection().getAllFeatures().contains(cidsFeature)) {
         ...
         * @throws  Exception  DOCUMENT ME!
         */
        public synchronized CidsFeature invoke(DefaultMetaTreeNode node, ObjectAttribute oAttr, boolean editable)
                throws Exception {
